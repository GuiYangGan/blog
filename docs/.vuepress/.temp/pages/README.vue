<template><h2 id="_1、页面导入样式时-使用link和-import有什么区别"><a class="header-anchor" href="#_1、页面导入样式时-使用link和-import有什么区别">#</a> 1、页面导入样式时，使用<code>link</code>和<code>@import</code>有什么区别</h2>
<ul>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h2 id="_4、html的元素有哪些-包含h5"><a class="header-anchor" href="#_4、html的元素有哪些-包含h5">#</a> 4、<code>html</code>的元素有哪些（包含H5）</h2>
<ul>
<li><b>行内元素</b>
<ul>
<li><code>a</code></li>
...
<h2 id="_5、css3有哪些新增特性"><a class="header-anchor" href="#_5、css3有哪些新增特性">#</a> 5、CSS3有哪些新增特性</h2>
<ul>
...
<h2 id="_6、写一个方法去掉字符串中的空格"><a class="header-anchor" href="#_6、写一个方法去掉字符串中的空格">#</a> 6、写一个方法去掉字符串中的空格</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">trim</span><span class="token punctuation">(</span><span class="token parameter">str</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  str<span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">(\s*$)</span><span class="token regex-delimiter">/</span><span class="token regex-flags">g</span></span><span class="token punctuation">,</span> <span class="token string">''</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="_7、html全局属性有哪些-包含h5"><a class="header-anchor" href="#_7、html全局属性有哪些-包含h5">#</a> 7、HTML全局属性有哪些（包含H5）</h2>
<ul>
...
<h2 id="_8、在页面上隐藏元素的方法有哪些"><a class="header-anchor" href="#_8、在页面上隐藏元素的方法有哪些">#</a> 8、在页面上隐藏元素的方法有哪些</h2>
<ul>
...
<h2 id="_9、去除字符串最后一个指定字符"><a class="header-anchor" href="#_9、去除字符串最后一个指定字符">#</a> 9、去除字符串最后一个指定字符</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="_10、html的文件离线存储怎么使用-工作原理是什么"><a class="header-anchor" href="#_10、html的文件离线存储怎么使用-工作原理是什么">#</a> 10、<span id="10">HTML的文件离线存储怎么使用，工作原理是什么</span></h2>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="_11、css选择器有哪些-哪些属性可以继承"><a class="header-anchor" href="#_11、css选择器有哪些-哪些属性可以继承">#</a> 11、CSS选择器有哪些？哪些属性可以继承？</h2>
<ul>
<li><b>选择器：</b>
<ul>
<li>通配符</li>
...
<h2 id="_12、写一个方法把下划线命名成大驼峰写法"><a class="header-anchor" href="#_12、写一个方法把下划线命名成大驼峰写法">#</a> 12、写一个方法把下划线命名成大驼峰写法</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h2 id="_13、简述a标签target属性的取值和作用"><a class="header-anchor" href="#_13、简述a标签target属性的取值和作用">#</a> 13、简述<code>a</code>标签<code>target</code>属性的取值和作用</h2>
<ul>
...
<h2 id="_14、css3新增伪类有哪些并简要描述"><a class="header-anchor" href="#_14、css3新增伪类有哪些并简要描述">#</a> 14、CSS3新增伪类有哪些并简要描述</h2>
<table>
<thead>
<tr>
<th>CSS3伪类</th>
...
<h2 id="_15、写一个把字符串大小写切换的方法"><a class="header-anchor" href="#_15、写一个把字符串大小写切换的方法">#</a> 15、写一个把字符串大小写切换的方法</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">caseConvert</span><span class="token punctuation">(</span><span class="token parameter">str</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token string">''</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h2 id="_16、label都有哪些作用-举例相应的例子说明"><a class="header-anchor" href="#_16、label都有哪些作用-举例相应的例子说明">#</a> 16、<code>label</code>都有哪些作用？举例相应的例子说明</h2>
<ul>
<li>
...
<h2 id="_17、用css创建一个三角形-并简述原理"><a class="header-anchor" href="#_17、用css创建一个三角形-并简述原理">#</a> 17、用CSS创建一个三角形，并简述原理</h2>
...
<h2 id="_18、写一个去处制表符和换行符的方法"><a class="header-anchor" href="#_18、写一个去处制表符和换行符的方法">#</a> 18、写一个去处制表符和换行符的方法</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="_19、iframe框架都有哪些优缺点"><a class="header-anchor" href="#_19、iframe框架都有哪些优缺点">#</a> 19、<code>iframe</code>框架都有哪些优缺点？</h2>
<ul>
<li><b>优点</b>
<ul>
...
<h2 id="_20、简述你对bfc规范的理解"><a class="header-anchor" href="#_20、简述你对bfc规范的理解">#</a> 20、<span id="20">简述你对BFC规范的理解</span></h2>
<ul>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h2 id="_22、简述下html5的离线存储原理-同时说明如何使用"><a class="header-anchor" href="#_22、简述下html5的离线存储原理-同时说明如何使用">#</a> 22、简述下HTML5的离线存储原理，同时说明如何使用</h2>
<p><a href="#10">参考第10条</a></p>
<h2 id="_23、清除浮动的方式有哪些及优缺点"><a class="header-anchor" href="#_23、清除浮动的方式有哪些及优缺点">#</a> 23、清除浮动的方式有哪些及优缺点</h2>
<ul>
<li><b>父元素添加浮动</b>
...
<h2 id="_24、写一个加密字符串的方法"><a class="header-anchor" href="#_24、写一个加密字符串的方法">#</a> 24、写一个加密字符串的方法</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h2 id="_25、浏览器多个标签页之间的通信方式有哪些"><a class="header-anchor" href="#_25、浏览器多个标签页之间的通信方式有哪些">#</a> 25、浏览器多个标签页之间的通信方式有哪些？</h2>
<ul>
...
<h2 id="_26、简述下你理解的优雅降级和渐进增强"><a class="header-anchor" href="#_26、简述下你理解的优雅降级和渐进增强">#</a> 26、简述下你理解的优雅降级和渐进增强</h2>
<ul>
<li><b>优雅降级</b>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h2 id="_28、viewport常见的设置有哪些"><a class="header-anchor" href="#_28、viewport常见的设置有哪些">#</a> 28、<code>viewport</code>常见的设置有哪些？</h2>
...
<h2 id="_29、对比-px、em、rem有什么不同"><a class="header-anchor" href="#_29、对比-px、em、rem有什么不同">#</a> 29、对比 <code>px</code>、<code>em</code>、<code>rem</code>有什么不同？</h2>
<ul>
<li><code>px</code>: 像素，相对长度单位，不会改变</li>
<li><code>em</code>: 1em = 当前元素的字体大小</li>
<li><code>rem</code>: 1rem = 当前html元素的字体大小</li>
</ul>
<h2 id="_30、简要描述下什么是回调函数并写一个例子出来"><a class="header-anchor" href="#_30、简要描述下什么是回调函数并写一个例子出来">#</a> 30、简要描述下什么是回调函数并写一个例子出来</h2>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="_31、对标签语义化的理解是什么"><a class="header-anchor" href="#_31、对标签语义化的理解是什么">#</a> 31、对标签语义化的理解是什么</h2>
<ul>
<li>代码结构清晰，方便阅读，有利于团队开发</li>
<li>方便其他设备解析，如移动设备、屏幕阅读器</li>
<li>有利于搜索引擎优化（SEO）</li>
</ul>
<h2 id="_32、css常的布局方式有哪些"><a class="header-anchor" href="#_32、css常的布局方式有哪些">#</a> 32、CSS常的布局方式有哪些？</h2>
<ul>
...
<h2 id="_33、简要描述下js有哪些内置的对象"><a class="header-anchor" href="#_33、简要描述下js有哪些内置的对象">#</a> 33、简要描述下JS有哪些内置的对象</h2>
<ul>
...
<h2 id="_34、常见浏览器内核有哪些-并介绍下你对内核的理解"><a class="header-anchor" href="#_34、常见浏览器内核有哪些-并介绍下你对内核的理解">#</a> 34、常见浏览器内核有哪些？并介绍下你对内核的理解</h2>
...
<h2 id="_35、说说你对css盒子模型的理解"><a class="header-anchor" href="#_35、说说你对css盒子模型的理解">#</a> 35、说说你对CSS盒子模型的理解</h2>
<ul>
...
<h2 id="_36、写一个获取当前url查询字符串中的参数的方法"><a class="header-anchor" href="#_36、写一个获取当前url查询字符串中的参数的方法">#</a> 36、写一个获取当前url查询字符串中的参数的方法</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="_37、网页应用从服务器主动推送到客户端有哪些方式"><a class="header-anchor" href="#_37、网页应用从服务器主动推送到客户端有哪些方式">#</a> 37、网页应用从服务器主动推送到客户端有哪些方式？</h2>
<p><code>websocket</code>、<code>EventSource</code>（SSE）</p>
<h2 id="_38、html5中的form怎么关闭自动完成"><a class="header-anchor" href="#_38、html5中的form怎么关闭自动完成">#</a> 38、HTML5中的<code>form</code>怎么关闭自动完成</h2>
<p><code>autocomplete=&quot;off&quot;</code></p>
<h2 id="_39、-before和-after中单冒号和双冒号的区别是什么-这两个伪元素有什么作用"><a class="header-anchor" href="#_39、-before和-after中单冒号和双冒号的区别是什么-这两个伪元素有什么作用">#</a> 39、<code>::before</code>和<code>:after</code>中单冒号和双冒号的区别是什么？这两个伪元素有什么作用？</h2>
<ul>
<li>CSS3是做了修订使用双冒号表示伪元素，来区别伪类</li>
<li><code>::before</code>在元素前面添加内容，<code>::after</code>在元素后面添加类容</li>
</ul>
<h2 id="_40、说说你对javascript的作用于的理解"><a class="header-anchor" href="#_40、说说你对javascript的作用于的理解">#</a> 40、说说你对Javascript的作用于的理解</h2>
<ul>
...
<h2 id="_41、http都有哪些状态码"><a class="header-anchor" href="#_41、http都有哪些状态码">#</a> 41、Http都有哪些状态码？</h2>
<table>
<thead>
<tr>
<th>状态码</th>
...
<h2 id="_42、为什么html5只需要写-doctype-html-就可以"><a class="header-anchor" href="#_42、为什么html5只需要写-doctype-html-就可以">#</a> 42、为什么HTML5只需要写<code>&lt;!DOCTYPE HTML&gt;</code>就可以？</h2>
...
<h2 id="_43、position-fixed-在ios下武侠怎么办"><a class="header-anchor" href="#_43、position-fixed-在ios下武侠怎么办">#</a> 43、<code>position: fixed;</code>在ios下武侠怎么办？</h2>
<ul>
...
<h2 id="_44、什么是闭包-优缺点分别是什么"><a class="header-anchor" href="#_44、什么是闭包-优缺点分别是什么">#</a> 44、什么是闭包？优缺点分别是什么？</h2>
<ul>
...
<h2 id="_45、你最喜欢用哪些编辑器-喜欢它的理由是什么"><a class="header-anchor" href="#_45、你最喜欢用哪些编辑器-喜欢它的理由是什么">#</a> 45、你最喜欢用哪些编辑器？喜欢它的理由是什么？</h2>
<p>VSCode: 打开速度快，多样的主题，插件功能强大，集成git</p>
<h2 id="_46、title与h1的区别-b与strong的区别-i与em的区别"><a class="header-anchor" href="#_46、title与h1的区别-b与strong的区别-i与em的区别">#</a> 46、<code>title</code>与<code>h1</code>的区别？<code>b</code>与<code>strong</code>的区别？<code>i</code>与<code>em</code>的区别？</h2>
<ul>
...
<h2 id="_47、style标签卸载body前和body后的区别是什么"><a class="header-anchor" href="#_47、style标签卸载body前和body后的区别是什么">#</a> 47、<code>style</code>标签卸载<code>body</code>前和<code>body</code>后的区别是什么？</h2>
...
<h2 id="_48、写一个数组去重的方法-支持多维数组"><a class="header-anchor" href="#_48、写一个数组去重的方法-支持多维数组">#</a> 48、写一个数组去重的方法（支持多维数组）</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><h2 id="_49、元素的alt和title有什么区别"><a class="header-anchor" href="#_49、元素的alt和title有什么区别">#</a> 49、元素的<code>alt</code>和<code>title</code>有什么区别？</h2>
<ul>
<li><code>alt</code>属性用于表示一个图片加载不出来是，对图片的描述</li>
<li><code>title</code>属性表示一个元素的额外信息，鼠标悬浮在元素上时出现的内容</li>
</ul>
<h2 id="_50、请描述margin边界得加是什么及解决方案"><a class="header-anchor" href="#_50、请描述margin边界得加是什么及解决方案">#</a> 50、请描述<code>margin</code>边界得加是什么及解决方案？</h2>
...
<p><a href="#20">BFC</a></p>
<h2 id="_51、返回顶部的方法有哪些-把其中一个方法写出来"><a class="header-anchor" href="#_51、返回顶部的方法有哪些-把其中一个方法写出来">#</a> 51、返回顶部的方法有哪些？把其中一个方法写出来</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
* 顶部放置 &lt;a name="top" />
...
<h2 id="_53、解释下css-sprites的原理和优缺点分别额是什么"><a class="header-anchor" href="#_53、解释下css-sprites的原理和优缺点分别额是什么">#</a> 53、解释下CSS sprites的原理和优缺点分别额是什么？</h2>
<ul>
<li><b>多张图合并成一张图</b></li>
<li><b>优点</b>
<ul>
...
<h2 id="_54、"><a class="header-anchor" href="#_54、">#</a> 54、</h2>
</template>